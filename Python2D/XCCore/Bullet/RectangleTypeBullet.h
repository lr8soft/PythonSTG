#pragma once
#ifndef _RECTANGLE_TYPE_BULLET_H_
#define _RECTANGLE_TYPE_BULLET_H_
#include "Bullet.h"
#include <glm/glm.hpp>
#include "../../util/GameTimer.h"
#include "../XCRender/XCImageHelper.h"
class RectangleTypeBullet :public Bullet {
private:
	/*
...
#£¡renderSize: scaleX * widthRate : scaleY * heightRate  ,collideSize : scaleX : scaleY*/
	RectangleTypeBullet(std::string bulletImagePath, glm::vec4 divideInfo, glm::vec3 scaleInfo, glm::vec3 initCoord,
