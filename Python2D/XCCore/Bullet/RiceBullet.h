#pragma once
#ifndef _RICE_BULLET_H_
#define _RICE_BULLET_H_
#include "Bullet.h"
#include <glm/glm.hpp>
#include "../../util/GameTimer.h"
#include "../XCRender/XCImageHelper.h"
class RiceBullet :public Bullet {
private:
	/*
...
public:
	RiceBullet(int bulletColor, glm::vec4 divideInfo, glm::vec3 scaleInfo, glm::vec3 initCoord
